...
def main():
    # input path
    mask_path = '/home/tin/deforestation/dataset/processed/masks/3847468.png'
    img_path = '/home/tin/deforestation/dataset/processed/visibles/3847468/composite.png'
    mask_path2 = '/home/tin/deforestation/dataset/processed/masks/84463945.png'
    img_path2 = '/home/tin/deforestation/dataset/processed/visibles/84463945/composite.png'

    # get source mask and img
    mask_src = np.asarray(Image.open(mask_path), dtype=np.uint8)
    save_colored_mask(mask_src, 'orig.png')
    img_src = cv2.imread(img_path)

    # random choice main mask/img
    mask_main = np.asarray(Image.open(mask_path2), dtype=np.uint8)
    img_main = cv2.imread(img_path2)

    # Copy-Paste data augmentation
    mask, img = copy_paste(mask_src, img_src, mask_main, img_main)

    mask_filename = "copy_paste_mask.png"
    img_filename = "copy_paste_img.png"
